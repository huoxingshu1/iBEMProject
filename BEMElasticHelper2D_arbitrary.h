...
public: 
    ...
    // for arbitrary 2D cases:
    double Triangle_area(double** coor);
    void Triangle_shape(double** coor, int n, double* SH);
    double Triangle_shape_6(double** coord, int n, double* x);
    void Trangle_shape_6_coeff_6(double* SH_0, double* SH_1, double* SH_2, double** coeff);
    void direction_normal(double* Vnorm, double* Vdir, double* x1, double* x2);
