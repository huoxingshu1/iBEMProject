...
extern double mu_0, nu0, mu_1, nu1;

class configElastic2D_arbitrary : public Config {
public:
    ...
    int Dimension = 2; double** s_pt;

    string particleInput = "position_2D_arbitrary.txt";
    string bemInput = "BEM_2D_arbitrary.txt";
    string postProcessInput = "postprocess_2D_arbitrary.txt";

    // here, eigen points are nodes of meshed arbitrary particles
