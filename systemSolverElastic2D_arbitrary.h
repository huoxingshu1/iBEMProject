...
class systemSolverElastic2D_arbitrary : public systemSolver {

    void solve(Config& config_);  // solve the syetem of equations
    template <typename T> void _solve(Config& config_);
};

void systemSolverElastic2D_arbitrary::solve(Config& config_) {

    _solve<configElastic2D_arbitrary>(config_);

}

template <typename T>
void systemSolverElastic2D_arbitrary::_solve(Config& config_) {
